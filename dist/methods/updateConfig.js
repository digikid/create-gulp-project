...
export default (function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { name: authorName, job, telegram, email, website, } = this.params.contacts;
        const fields = {
            description,
            copyright,
        };
        ...
        try {
            ...
            for (const file of ['package.json', 'package-lock.json']) {
                ...
                yield writeFileAsync(filePath, JSON.stringify(data, null, 2));
            }
            ...
            yield replaceAsync(configPath, [/\{\}/, configData]);
            ...
            yield writeFileAsync(readmePath, readmeData);
